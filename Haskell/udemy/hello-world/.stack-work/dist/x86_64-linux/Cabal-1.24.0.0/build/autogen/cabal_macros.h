...
/* package hello-world-0.1.0.0 */
#define VERSION_hello_world "0.1.0.0"
...
#define CURRENT_COMPONENT_ID "hello-world-0.1.0.0"

#define CURRENT_PACKAGE_KEY "hello-world-0.1.0.0"
